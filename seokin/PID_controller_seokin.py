...
class CarController:
    def __init__(self, client, car_name):
        ...
        self.pid_distance_curve = PID(dt=0.05, Kp=0.05, Ki=0.001, Kd=0)
        self.pid_degrees_curve = PID(dt=0.05, Kp=2, Ki=0.001, Kd=0)
    ...
    def compute(self, coordinates):
        ...
        print ("err", math.degrees(err_degree_convert))
        print("===============================")
        return done, d
