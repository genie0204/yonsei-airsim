    ...
    for i in range(episodes):
        ...
        for t in range(steps):
            ...
            if (done):
                ...
                agent.actor_net.save_actor('/home/myounghoe/ddpgtf/norepeat_target_2action_scale2/weights/actor/model.ckpt')
                agent.critic_net.save_critic('/home/myounghoe/ddpgtf/norepeat_target_2action_scale2/weights/critic/model.ckpt')
                print ('\n\n')
                break
